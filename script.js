...
let tiempo = 40;
let necesarios = 40;
let victoria = localStorage.getItem("victoria") ? parseInt(localStorage.getItem("victoria")) : 0;
...
>>>>>>> de52a0d67a8bde4cdc18b5154ff23fef9d1d66b9
}
...
function movimientoEnemigo() {
    ...
    if (window.innerWidth <= 560) {
        ...
        document.getElementById("enemigoDos").style.marginBottom = randNumE2 + "px";
        document.getElementById("enemigoDos").style.marginRight = randNumX2 + "px";
    }
=======
function movimientoBomba(){
    randNumE = Math.round(Math.random()*350);
